campaign "Battles"
{
    ...
    {
	    CreateGamePlayer(1, 1, eRaceED, true);
    }

    function void RegisterMissions()
    {
        RegisterMission(1, "Levels\\BattleForIo.lnd", "Scripts\\Campaigns\\LC\\Missions\\DestroyEnemyBuildings.eco", "translateBattleForIo", "translateL_M1_Description", "", 0);
        RegisterMission(2, "Levels\\BattleForEden.lnd", "Scripts\\Campaigns\\LC\\Missions\\DeastroyEnemyBuildings.eco", "translateBattleForEden", "translateL_M2_Description", "Interface\\Campaign\\L_M2.prt", 53);
