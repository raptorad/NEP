campaign "Battles"
{
    ...
    {
        RegisterMission(1, "Levels\\BATTLE FOR IO.lnd", "Scripts\\Campaigns\\LC\\Missions\\DestroyStuctures.eco", "translateBattleForIo", "translateL_M1_Description", "", 0);
        RegisterMission(2, "Levels\\BATTLE FOR EDEN.lnd", "Scripts\\Campaigns\\LC\\Missions\\DeastroyStructures.eco", "translateBattleForEden", "translateL_M2_Description", "Interface\\Campaign\\L_M2.prt", 53);
